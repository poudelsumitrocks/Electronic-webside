      ...
      >
        ...
        >
          <ul className="space-y-1 text-sm">
            <li className="hover:bg-gray-100 p-1 rounded">Celling Fan</li>
            <li className="hover:bg-gray-100 p-1 rounded">Table Fan</li>
            <li className="hover:bg-gray-100 p-1 rounded">Stand fan</li>
            <li className="hover:bg-gray-100 p-1 rounded">Adjust fan</li>
          </ul>
        </div>
      </div>
    </div>
