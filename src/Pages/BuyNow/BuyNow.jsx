...
export default function BuyNowPage() {
  ...
  const handleOrder = (e, method) => {
    ...
    // Show Cash on Delivery modal
    if (method === "Cash on Delivery") {
      setShowCODInfo(true);
    }
  };

  // Handle selecting online payment platform
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Checkout form */}
        <form className="flex flex-col gap-4" onSubmit={(e) => handleOrder(e, "Pay Online")}>
          <input
            name="fullName"
            type="text"
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4">
            ...
            <button
              type="button"
              onClick={() => handleOrder(new Event("click"), "Cash on Delivery")}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className={`p-6 rounded-lg w-11/12 md:w-1/2 ${isDark ? "bg-gray-800 text-white" : "bg-gray-50 text-gray-900"}`}>
            <h2 className="text-2xl font-semibold mb-4">Choose Online Payment Platform</h2>
            ...
            {/* eSewa/Khalti QR */}
            {(selectedPlatform === "eSewa" || selectedPlatform === "Khalti") && (
              <div className="mb-4 flex flex-col items-center bg-gray-100 dark:bg-gray-700 p-4 rounded-md">
                <p className="mb-2 font-semibold">{selectedPlatform} QR Code:</p>
                <img
                ...
                <div className="mt-4 w-full">
                  ...
                  <input type="file" accept="image/*" onChange={handleScreenshotUpload} className="w-full"/>
                  {paymentScreenshot && (
                    <p className="mt-2 text-green-600">{paymentScreenshot.name} uploaded</p>
                  )}
                </div>
              </div>
            )}
